"""
AI Product Inspector — Email bot MVP (v2, with OpenRouter)
===================================================================
...
3. An OpenRouter API key (with credits)
...
MODEL = "anthropic/claude-3.5-sonnet"  # Best vision model for product inspection
            ...
            if image_bytes:
                try:
                    ...
                    if e.response.status_code == 429:
                        log.warning("Rate limited. Skipping email.")
...
def main():
    ...
    log.info("AI Product Inspector (OpenRouter/Claude mode) starting. Polling every %ss", POLL_INTERVAL_SECONDS)
    while True:
        try:
            process_inbox()
        except Exception:
